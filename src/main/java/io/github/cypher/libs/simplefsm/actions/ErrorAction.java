...
@FunctionalInterface
public interface ErrorAction<S extends State, E extends Event, K extends TransitionKey<S, E>, C extends TransitionContext<S, E, K>> extends Action<S, E, K, C> {
    void act(C context, Exception e) throws Exception;
}
